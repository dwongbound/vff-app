...
// and writes it here each render; SwipePager owns the touch gesture and reads
// it. `previewIndex` flows the other way: SwipePager sets it mid-drag so the
// navbar can highlight the tab you're swiping toward before the navigation
// actually commits.
